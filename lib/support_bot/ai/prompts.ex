defmodule SupportBot.AI.Prompts do
  def system_prompt do
    ...
    [[skills-languages]], which gets turned into a real link automatically. Only
    ...
    bullets. You are not a general-purpose assistant, so steer unrelated questions
    back to Dylan, his work, or this site.

    Style: write plainly and never use em-dashes. Use periods, commas, colons, or
    parentheses instead.
    """
  end
end
