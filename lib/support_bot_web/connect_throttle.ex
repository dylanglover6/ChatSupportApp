defmodule SupportBotWeb.ConnectThrottle do
  ...
  reconnect storm can't spin up unbounded LiveView processes (see
  plans/04-PLAN-security.md, Pass 2). Only the connected (websocket) mount counts —
  the dead render is already covered by the router's `:request` throttle.
