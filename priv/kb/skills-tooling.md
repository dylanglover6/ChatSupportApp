...
category: Skills
order: 4
summary: Support systems, APIs, infra, and the tools Dylan works with day to day.
---
...
- **Zendesk, Jira, Salesforce**: years of daily use for triage, severity, escalation
  workflows, and SLA-minded customer communication.
...
- **Browser DevTools, API response inspection, log analysis**: the primary lenses for
  root-cause work.
- **Networking fundamentals**: TLS/SSL, TCP/IP, DNS, VPNs, firewalls, enough to reason
  about where in the stack a problem actually lives.
